...
<article class="post" id="post<%=Index %>">
    <header class="post-header">
        ...
        <div class="post-info clearfix">
            ...
            <a rel="nofollow" class="post-comment-link" href="<%=Post.RelativeOrAbsoluteLink %>#comment"><i class="glyphicon glyphicon-comment"></i>(<%=Post.ApprovedComments.Count %>)</a>
        </div>
    </header>
...
<div class="post-line-footer clearfix"><div class="pull-left"></div><div class="pull-right"></div></div>